...
class GraphitiService:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            # Store entity types and custom extraction instructions for later use
            self.entity_types = custom_types
            self.custom_extraction_instructions = self.config.graphiti.custom_extraction_instructions
...
async def add_memory(
    ...
    try:
        ...
        await queue_service.add_episode(
            ...
            custom_extraction_instructions=graphiti_service.custom_extraction_instructions,
